...
def network_graph_data():
    ...
    network_gml_file_path = os.path.join(lib_path_flows_graphs,'G_d4_n400_gen.gml')
...
def network_custom_layout(G):
    ...
    gviz_file_path = os.path.abspath(os.path.join(dir_path,'rsc','gviz','G_d4_n400_gen.txt'))
