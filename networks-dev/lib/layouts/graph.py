...
def layout_network_graph(G,PRIORITY_GRAPHVIZ_LAYOUT,graphviz_layout):
    ...
    if (gviz == True and PRIORITY_GRAPHVIZ_LAYOUT == 1) :
        pos = nx.graphviz_layout(G, prog=graphviz_layout)
    else: 
    ...
    for n in G.nodes_iter():
        ...
        G.add_node(n,pos= str([point[0],point[1],0.0]))
...
def addNodePositionsToGraph(G,PRIORITY_GRAPHVIZ_LAYOUT,layout):
