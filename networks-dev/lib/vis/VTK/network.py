...
import lib.vis.colormaps as cmap
...
class VtkNetworkAnimationLayer:
    ...
    def _initialize(self, G, sim_data_pars, z_index):
        ...
        for i in xrange(numberOfTuples+1):
            color = (0,0,min_color + i*delta_color,1)
...
class VtkNetworkDataTimesLayer(VtkNetworkStaticLayer):
    ...
    def __init__(self, G, z_index=3):
        ...
        self.vtkColorBarActor.GetProperty().SetOpacity(0)
        self.vtkColorBarActor.GetTitleTextProperty().SetOpacity(0)
        
        self.G = G
        self.displayEdgeTimes()
        self.vtkActor.GetProperty().SetOpacity(0)
