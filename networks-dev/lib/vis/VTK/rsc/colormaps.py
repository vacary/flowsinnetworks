...
def getColorMap(value):
    ...
    if (value == 0):
        ...
        #black2blue1
        colorList = "#0000FF,#0000F2,#0000E6,#0000DA,#0000CE,#0000C2,#0000B6,#0000AA,#00009D,#000091,#000085,#000079,#00006D,#000061,#000055,#000048,#00003C,#000030,#000024,#000018,#00000C,#000000"
        colorList = colorList.replace("#","")
        aux = colorList.split(",")
        colorMap = []
        for hexColor in aux:
        ...
        #white2blue1
        colorList = "#0000FF,#0C0CFF,#1818FF,#2424FF,#3030FF,#3C3CFF,#4848FF,#5555FF,#6161FF,#6D6DFF,#7979FF,#8585FF,#9191FF,#9D9DFF,#AAAAFF,#B6B6FF,#C2C2FF,#CECEFF,#DADAFF,#E6E6FF,#F2F2FF,#FFFFFF"
        colorList = colorList.replace("#","")
        aux = colorList.split(",")
        colorMap = []
        for hexColor in aux:
        ...
        colorList = "#0000FF,#0000F9,#0000F3,#0000ED,#0000E7,#0000E1,#0000DC,#0000D6,#0000D0,#0000CA,#0000C4,#0000BF,#0000B9,#0000B3,#0000AD,#0000A7,#0000A2,#00009C,#000096,#000090,#00008A,#000085"
        colorList = colorList.replace("#","")
        aux = colorList.split(",")
        colorMap = []
        for hexColor in aux:
