...
from display.GUI.classes.MainWindow import * # Qt Gui Elements
import display.GUI.classes.Dialog as Qt_Dialog

# Custom action modules for GUI
import display.GUI.actions.actors as actions_actors
import display.GUI.actions.animation as actions_animation
import display.GUI.actions.plot as actions_plot

from display.vis.visualization import * # Visualization Class
...
class PlotDialog(QtGui.QDialog):
    ...
    def update(self,time):
        ...
        edge_dict = {}
        try:                
            f = open(os.path.join(vroot_dir_path,'temp','data.txt'),"r")
...
class MainWindow(QtGui.QMainWindow):
    ...
    def closeEvent(self,event):
        ...
        f = open(os.path.join(vroot_dir_path,'temp','data.txt'),"w")
        f.write(json.dumps({}))
        f.close()
...
if __name__ == "__main__":
    ...
    viz = Visualization(NETWORK_NAME, PROJECT_DIR_PATH)
